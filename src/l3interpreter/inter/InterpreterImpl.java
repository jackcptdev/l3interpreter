...
import l3interpreter.antlr.L3Parser.CallMemberLabelContext;
import l3interpreter.antlr.L3Parser.CallMethodLabelContext;
import l3interpreter.antlr.L3Parser.ConditionLabelContext;
import l3interpreter.antlr.L3Parser.ContinueLabelContext;
import l3interpreter.antlr.L3Parser.CreatorLabelContext;
...
import l3interpreter.antlr.L3Parser.ImportLabelContext;
import l3interpreter.antlr.L3Parser.IndexVisitLabelContext;
import l3interpreter.antlr.L3Parser.InnerClassNameLabelContext;
...
import l3interpreter.antlr.L3Parser.NewLabelContext;
import l3interpreter.antlr.L3Parser.OrLabelContext;
import l3interpreter.antlr.L3Parser.PackagePathLabelContext;
...
import l3interpreter.antlr.L3Parser.VarDefLabelContext;
...
public class InterpreterImpl extends L3BaseVisitor<Identity> {
	...
	@Override
	public Identity visitCreatorLabel(CreatorLabelContext ctx) {
		// TODO Auto-generated method stub
		return super.visitCreatorLabel(ctx);
	}

	@Override
	public Identity visitPackagePathLabel(PackagePathLabelContext ctx) {
		// TODO Auto-generated method stub
		return super.visitPackagePathLabel(ctx);
	}

	@Override
	public Identity visitCallMethodLabel(CallMethodLabelContext ctx) {
		// TODO Auto-generated method stub
		return super.visitCallMethodLabel(ctx);
	}

	@Override
	public Identity visitNewLabel(NewLabelContext ctx) {
		// TODO Auto-generated method stub
		return super.visitNewLabel(ctx);
	}

	@Override
	public Identity visitVarDefLabel(VarDefLabelContext ctx) {
		// TODO Auto-generated method stub
		return super.visitVarDefLabel(ctx);
	}

	@Override
	public Identity visitCallMemberLabel(CallMemberLabelContext ctx) {
		// TODO Auto-generated method stub
		return super.visitCallMemberLabel(ctx);
	}

	@Override
	public Identity visitImportLabel(ImportLabelContext ctx) {
		// TODO Auto-generated method stub
		return super.visitImportLabel(ctx);
	}

	@Override
	public Identity visitInnerClassNameLabel(InnerClassNameLabelContext ctx) {
		// TODO Auto-generated method stub
		return super.visitInnerClassNameLabel(ctx);
	}
